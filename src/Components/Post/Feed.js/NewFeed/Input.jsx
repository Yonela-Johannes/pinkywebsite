...
export default function Input({user, admin }) {
  ...
  return (
    <div className={`border-b border-gray-700 p-3 flex-space-x3 overflow-y-scroll`}>
            ...
            {selectedFile && ( 
              <div className='relative'>
                <div className='absolute w-8 h-8 bg-[pink] hover:[bg-gray] bg-opacity-75 rounded-full flex items-center 
                  justify-center top-1 left-1 cursor-pointer' onClick={() => selectedFile(null)}><BiMessageSquareAdd /></div>
